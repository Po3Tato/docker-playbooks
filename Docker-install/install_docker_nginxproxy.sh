...
installApps()
{
    ...
    ISACT=$( (sudo systemctl is-active docker ) 2>&1 ) ## this checks if docker is installed
...
#######################################################
    ...
    sudo docker network create muso-main-net
    sleep 2s
    ...
    if [[ "$NPM" == [yY] ]]; then
        ...
        curl https://raw.githubusercontent.com/Po3Tato/docker_install/main/docker_compose.nginx_proxy_manager.yml -o docker-compose.yml >> ~/docker-script-install.log 2>&1
    ...
    if [[ "$PORT" == "1" ]]; then
        ...
        cd docker/portainer
        curl https://raw.githubusercontent.com/Po3Tato/docker_install/main/docker_compose_portainer_ce.yml -o docker-compose.yml >> ~/docker-script-install.log 2>&1
        echo ""
    ...
    if [[ "$PORT" == "2" ]]; then
        ...
        cd docker/portainer
        curl https://raw.githubusercontent.com/Po3Tato/docker_install/main/docker_compose_portainer_ce_agent.yml -o docker-compose.yml >> ~/docker-script-install.log 2>&1
        echo ""
    ...
    echo "All docker applications have been added to the docker network muso-main-net"
    echo ""
    echo "If you add more docker applications to this server, make sure to add them to the muso-main-net network."
